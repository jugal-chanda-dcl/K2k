        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="profession" class="col-md-4 col-form-label text-md-right text-capitalize">{{ __('profession') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="address" class="col-md-4 col-form-label text-md-right text-capitalize">{{ __('address') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="birthdate" class="col-md-4 col-form-label text-md-right text-capitalize">{{ __('birthdate') }}</label>
